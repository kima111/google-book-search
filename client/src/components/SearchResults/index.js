    ...
    <ul className="list-group search-results">
      ...
      {props.results.map(result => (
        <li className="list-group-item">
          ...
          <br />
          <br />
          <button type="submit" title={result.volumeInfo.title} author={result.volumeInfo.authors[0]} synopsis ={result.volumeInfo.description} onClick={props.handleSaveChange} className="btn btn-success">
